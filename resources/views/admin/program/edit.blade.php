...
@section('title', 'Admin | Edit Program')
...
<div class="kt-pagebody">
  ...
  <div class="card pd-20 pd-sm-40">
    ...
    <div class="table-wrapper">
      ...
      <form class="form-horizontal tasi-form" action="{{ route('admin_program.update',$data->program_id) }}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        {{ method_field('PUT') }}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" value="{{$data->program_nama}}" class="form-control" name="program_nama" placeholder="Isikan Nama Program">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <select id="bidang_id" class="form-control" name="bidang_id">
              ...
              <option value="{{ $list->bidang_id }}" {{ $data->bidang_id==$list->bidang_id ? 'selected' : '' }} > {{ $list->bidang_nama }} </option>
              @endforeach
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <input type="number" value="{{$data->program_estimasi_biaya}}" class="form-control" name="program_estimasi_biaya" placeholder="example : 2500000">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" value="{{$data->program_volume_satuan}}" class="form-control" name="program_volume_satuan" placeholder="Isikan Volume Satuan">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" value="{{$data->program_satuan_kerja}}" class="form-control" name="program_satuan_kerja" placeholder="Isikan Satuan Kerja">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <select id="program_jenis" class="form-control" name="program_jenis">
              <option value="">-- Pilih --</option>
              <option value="1" {{ $data->program_jenis==1 ? 'selected' : '' }}> Program Prioritas </option>
              <option value="2" {{ $data->program_jenis==2 ? 'selected' : '' }}> Program Tambahan </option>
