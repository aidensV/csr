        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="row row-sm mg-t-0">
                    <div class="col-sm-4">
                        <div class="card pd-20 tx-center">
                            ...
                            <div class="d-flex justify-content-center mg-b-30">
                                @if ($galeri->galeri_pelaksanaan_gb1 == !null)
                                    <input type="hidden" name="vlimage1" id="vlimage1" value="0"/>
                                    <img style="height:250px;width:200px;" id="gbr1" src="{{asset('/public/images/tumb/tumb-'.$galeri->galeri_pelaksanaan_gb1)}}" class="wd-100" alt="">
                ...
                <div class="col-sm-4">
                        <div class="card pd-20 tx-center">
                              <div class="d-flex justify-content-center mg-b-30">
                                @if ($galeri->galeri_pelaksanaan_gb2 == !null)
                                <img style="height:250px;width:200px;" id="gbr2" src="{{asset('/public/images/tumb/tumb-'.$galeri->galeri_pelaksanaan_gb2)}}" class="wd-100" alt="">
                ...
                <div class="col-sm-4" >
                        <div class="card pd-20 tx-center">
                            <div class="d-flex justify-content-center mg-b-30">
                                @if ($galeri->galeri_pelaksanaan_gb3 == !null)
                                    <input type="hidden" name="vlimage3" id="vlimage3" value="0"/>
                                    <img style="height:250px;width:200px;" id="gbr3" src="{{asset('/public/images/tumb/tumb-'.$galeri->galeri_pelaksanaan_gb3)}}" class="wd-100" alt="">
                                @else
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <a href="{{url('admin_galeri')}}" ><button class="btn btn-primary">Kembali</button></a>
                        </div>
                    </div>
