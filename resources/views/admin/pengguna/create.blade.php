...
<div class="kt-pagebody">
  ...
  <div class="card pd-20 pd-sm-40">
    ...
    <div class="table-wrapper">
      <form class="form-horizontal tasi-form" action="{{ route('admin_users.store') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                @if ($pesan_error=="1")
    						...
    						@endif
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="nama" placeholder="Isikan Nama Pengguna">
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">Email <span class="tx-danger">*</span></label>
                                      <div class="col-sm-10">
                                          <input type="email" class="form-control" name="email" placeholder="abcde@gmail.com">
                                      </div>
                                  </div>


                                  <div class="form-group">
                                      <label class="col-sm-4 col-sm-4 control-label">Password <span class="tx-danger">*</span> default (<span class="tx-danger"> csr12345</span>)</label>
                                      <div class="col-sm-10">
                                          <input type="password" readonly value="csr12345" class="form-control" name="password" placeholder="Isikan Nama Agenda">
                                      </div>
                                  </div>
