                ...
                @if ($errors->any())
    						...
    						@endif
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" value="{{$data->admin_nama}}" class="form-control" name="nama" placeholder="Isikan Nama Agenda">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group" style="display:none;">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" value="-" class="form-control" name="nohp" placeholder="Isikan No. HP Pengguna">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group" style="display:none;">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" value="-" class="form-control" name="alamat" placeholder="Isikan Alamat Pengguna">
                                      </div>
                                  </div>
