...
@section('title', 'Admin | Master Bidang')
          ...
          <table id="datatable1"  class="table display responsive nowrap">
            <thead>
              <tr>
                ...
                <th class="wd-25p">Nama Bidang</th>
...
<script type="text/javascript">
	...
	$(function(){
      ...
      if(!e.isDefaultPrevented()){
         var id = $('#id').val();
         if(save_method == "add") url = "{{ route('admin_bidang.store') }}";
         else url = "admin_bidang/"+id;
