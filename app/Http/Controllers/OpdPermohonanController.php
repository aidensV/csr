...
class OpdPermohonanController extends Controller
{
    ...
    public function index()
    {
        $opd_permohonan = Permohonan::join('tbl_opd', 'tbl_opd.opd_id', '=', 'tbl_permohonan.opd_id')
            ...
            ->get();
        foreach ($opd_permohonan as $permohonan){
            $st = $permohonan->permohonan_status;
        ...
        return view('opd.permohonan.index', compact('opd_permohonan'))->with('status',$status);
    }
    ...
    public function show($id)
    {
        ...
        $permohonan = Permohonan::join('tbl_opd','tbl_permohonan.opd_id','=','tbl_opd.opd_id')
            ...
            ->get();
        return view('opd.permohonan.show',compact('permohonan','file_permohonan'));
    }
